                ...
                if definition_tag.name == "p":
                    if definition_tag.text.strip():
                        ...
                        definition_links.extend(
                            [e.text for e in definition_tag.find_all("a")]
                        )
                if definition_tag.name in ["ol", "ul"]:
                    for element in definition_tag.find_all("li", recursive=False):
                        if element.text:
                            ...
                            definition_links.extend(
                                [e.text for e in element.find_all("a")]
                            )
            if def_type == "definitions":
                def_type = ""
            definition_list.append(
                (def_index, definition_text, def_type, definition_links)
            )
            ...
            for (
                ...
                if (
                    ...
                    def_obj = Definition(
                        ...
                        part_of_speech=definition_type,
