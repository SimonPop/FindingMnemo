...
from finding_mnemo.dataset.wiktionary_graph.wiktionaryparser.core import WiktionaryParser
from finding_mnemo.dataset.wiktionary_graph.wiktionay_entry import WiktionaryEntry
